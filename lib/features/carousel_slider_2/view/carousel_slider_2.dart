...
class MyCarouselSlider2 extends StatefulWidget {
  final void Function()? onPressed;
  const MyCarouselSlider2({super.key, this.onPressed});

  @override
  State<MyCarouselSlider2> createState() => _MyCarouselSliderState();
}

class _MyCarouselSliderState extends State<MyCarouselSlider2>
          ...
          child: Column(children: [
            ...
            TabPageSelector(
              controller: TabController(
                  length: assets.length,
                  vsync: this,
                  initialIndex: thirdcurrentindex % assets.length),
            )
          ]),
        )));
  }
